<%@ Page Language="C#" MasterPageFile="~/Site_9288.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="ShreeDhar_BookStore_9288.Checkout" %>
    ...
    <main>
        ...
        <div class="row">
            <div>
                ...
                <asp:Button runat="server" ID="continueShoppingButton" Text="Continue Shopping" PostBackUrl="~/Products_288" CssClass="btn btn-success" />
            </div>
        </div>
    </main>
</asp:Content>
